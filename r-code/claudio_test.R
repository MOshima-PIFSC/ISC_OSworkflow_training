...
# change Natural Mortality and run alternative versions of the model
...
# read control file
    ...
    names(tmp_ctl)
# modify
    tmp_ctl$MG_parms["NatM_p_1_Mal_GP_1", "INIT"] = 0.3
    tmp_ctl$MG_parms["NatM_p_1_Fem_GP_1", "INIT"] = 0.2

   # tmp_ctl$SR_parms["SR_BH_steep","INIT"] = 0.7
# make new directory
             tmp_dir = paste0(dir_model,"nat_M","/")
